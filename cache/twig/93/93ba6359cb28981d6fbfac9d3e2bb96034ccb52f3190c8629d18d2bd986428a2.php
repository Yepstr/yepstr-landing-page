...
class __TwigTemplate_254957b6563ea677cad8aec1c52020df0efbcd064085548fe58e116f4391d2e7 extends Twig_Template
{
...
";
    ...
    {
        return "{% set showcase_image = page.media.images|first.grayscale().contrast(20).brightness(-125).colorize(-35,81,122) %}
{% if showcase_image %}
